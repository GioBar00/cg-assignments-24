...
***************/
	...
	M = glm::mat4(1.0f);
    M = glm::scale(M, glm::vec3(2.0f, 1.0f, 1.25f));
    M = glm::translate(M, glm::vec3(0.0f, 0.0f, -1.0f));
	...
	M = glm::mat4(1.0f);
    M = glm::shearZ3D(M, 0.5f, 0.0f);
    M = glm::shearX3D(M, 0.0f, 2.0f / 3.0f);
    M = glm::rotate(M, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    M = glm::scale(M, glm::vec3(2.0f, 1.0f, 1.5f));
    M = glm::translate(M, glm::vec3(-1.0f / 3.0f, 2.0f, 1.0f / 3.0f));
    ...
    M = glm::translate(M, glm::vec3(-1.0f, 1.0f, 1.5f));
	A->SetMatrix(10, M, false);

	M = glm::mat4(1.0f);
    M = glm::rotate(M, glm::radians(135.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    M = glm::translate(M, glm::vec3(-2.707f, 2.0f, -0.878f));
	...
	M = glm::mat4(1.0f);
    M = glm::rotate(M, glm::radians(90.0f), glm::normalize(glm::vec3(-1.0f, 0.0f, 1.0f)));
    M = glm::rotate(M, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    M = glm::translate(M, glm::vec3(-0.915f, -0.7075f, 0.915f));
	A->SetMatrix(13, M, false);
	
	M = glm::mat4(1.0f);
    M = glm::rotate(M, glm::radians(150.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    M = glm::translate(M, glm::vec3(2.231f, 2.0f, 0.134f));
