...
***************/
glm::mat4 MakeViewProjectionLookInDirection(glm::vec3 Pos, float Yaw, float Pitch, float Roll, float FOVy, float Ar,
    ...
    glm::mat4 View = glm::rotate(glm::mat4(1.0f), -Roll, glm::vec3(0.0f, 0.0f, 1.0f)) *
